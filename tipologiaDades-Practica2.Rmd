...
Primer escalarem les dades ja que estàn totes en escales diferents:

## Abans d'escalar s'ha de discretitzar la variable de sortida entre qualitat baixa, mitjana i alta i no escalar-la !
...
indexes = sample(1:nrow(wine.Scal),size=floor((2/3)*nrow(wine.Scal)))
indexes
