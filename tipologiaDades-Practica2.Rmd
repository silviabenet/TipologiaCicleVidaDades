...
```
 ...
 La predicció del model és del 59%, que és un valor molt baix. Si mirem el valor de kappa és del 33%. Si ens hi fixem l'algoritme és incapaç de predir els vins amb qualitat 3, 4 i 8. D'aquests l'encert és 0. Només és capaç de prediure les qualitats 5, 6 i 7 amb un encert de 30 % aprox (30%,25%,36% ). Per tant el model no ens és massa útil.
...
part <- rpart(quality ~. , data = wineQualityRed)
part
```
...
Obtenim una predicció amb un acert del 88%.
