 ...
 * Qualitat 8 -> 0
 ...
 Hem provat també d'escalar la variable qualitat repartint les dades entre: Qualitat baixa, mitja baixa, mitja alta i alta, però el resultat ha estat molt semblant a l'enterior. El model ens pediu les qualitats mitjes amb una precisió d'un 60 %.